...
```
In this chunk, I imported the Mr. Trash Wheel datasheet from cells A2 to N258. I then cleaned the variable names, filtered out the dumpster total rows, and then mutated the sports_balls variable to round it up to the nearest integer.
